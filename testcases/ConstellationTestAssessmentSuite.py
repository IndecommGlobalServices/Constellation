...
filename = "TestResult - Assessments_" + str(datetime.today().date()) +"_"+ str(datetime.today().time().hour)+"-"+str(datetime.today().time().minute)+".xml"
cwd = os.getcwd()
os.chdir('..')
...
nose.run(argv=["","assessmentoverviewtest",
               ...
               "assessmentpoliciesandplanningtest", "assessmenttrainingandexercisetest",
