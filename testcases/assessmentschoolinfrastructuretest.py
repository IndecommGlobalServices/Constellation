...
class AssessmentSchoolInfrastructurePageTest(BaseTestCase):
    ...
    def test_AST_127_To_Verify_Edit_Caption_SECTION_SURROUNDING_PARKING(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_SURROUNDING'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_SURROUNDING'),
                                                               self.config.get(self.subsection, 'SECTION_SURROUNDING_PARKING'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_SURROUNDING'),
                                                      self.config.get(self.subsection, 'SECTION_SURROUNDING_PARKING'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_131_To_Verify_Edit_Caption_SECTION_SURROUNDING_ADJACENTBUILDINGS(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_SURROUNDING'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_SURROUNDING'),
                                                               self.config.get(self.subsection, 'SECTION_SURROUNDING_ADJACENTBUILDINGS'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_SURROUNDING'),
                                                      self.config.get(self.subsection, 'SECTION_SURROUNDING_ADJACENTBUILDINGS'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_134_To_Verify_Fileupload_SECTION_ELECTRIC_UTILITY(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                        self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                        self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                             self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                      self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_135_To_Verify_Edit_Caption_SECTION_ELECTRIC_UTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                               self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY'),
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                        self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                      self.config.get(self.subsection, 'SECTION_ELECTRIC_UTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_139_To_Verify_Edit_Caption_SECTION_ELECTRIC_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                               self.config.get(self.subsection, 'SECTION_ELECTRIC_LOSSOFUTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                      self.config.get(self.subsection, 'SECTION_ELECTRIC_LOSSOFUTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_142_To_Verify_Edit_Caption_SECTION_ELECTRIC_BACKUPGENERATOR(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                               self.config.get(self.subsection, 'SECTION_ELECTRIC_BACKUPGENERATOR'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                      self.config.get(self.subsection, 'SECTION_ELECTRIC_BACKUPGENERATOR'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_146_To_Verify_Edit_Caption_SECTION_ELECTRIC_GENERATORPOWERED(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                               self.config.get(self.subsection, 'SECTION_ELECTRIC_GENERATORPOWERED'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ELECTRIC'),
                                                      self.config.get(self.subsection, 'SECTION_ELECTRIC_GENERATORPOWERED'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_149_To_Verify_Fileupload_SECTION_TELEPHONE_PROVIDER(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                                        self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                        self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                                             self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                                      self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_150_To_Verify_Edit_Caption_SECTION_TELEPHONE_PROVIDER(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                               self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'),
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                                               self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                                      self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_151_To_Verfiy_Add_Comment_SECTION_TELEPHONE_PROVIDER(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                         self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                    self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                           self.config.get(self.subsection, 'SECTION_TELEPHONE_PROVIDER'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_154_To_Verify_Edit_Caption_SECTION_TELEPHONE_911PROCEDURE(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                    self.config.get(self.subsection, 'SECTION_TELEPHONE_911PROCEDURE'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                                      self.config.get(self.subsection, 'SECTION_TELEPHONE_911PROCEDURE'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_155_To_Verfiy_Add_Comment_SECTION_TELEPHONE_911PROCEDURE(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                    self.config.get(self.subsection, 'SECTION_TELEPHONE_911PROCEDURE')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_TELEPHONE'),
                                           self.config.get(self.subsection, 'SECTION_TELEPHONE_911PROCEDURE'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_158_To_Verify_Edit_Caption_SECTION_BUSES_DISTRICTTRANSPORTATION(self):
        ...
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                             self.config.get(self.subsection, 'SECTION_BUSES_DISTRICTTRANSPORTATION'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_DISTRICTTRANSPORTATION'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_159_To_Verfiy_Add_Comment_SECTION_BUSES_DISTRICTTRANSPORTATION(self):
        ...
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_BUSES'),
            self.config.get(self.subsection, 'SECTION_BUSES_DISTRICTTRANSPORTATION')).get_attribute("value"), "Comment")
    ...
    def test_AST_162_To_Verify_Edit_Caption_SECTION_BUSES_GPS(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                               self.config.get(self.subsection, 'SECTION_BUSES_GPS'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_GPS'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_163_To_Verfiy_Add_Comment_SECTION_BUSES_GPS(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                self.config.get(self.subsection, 'SECTION_BUSES_GPS')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                           self.config.get(self.subsection, 'SECTION_BUSES_GPS'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_166_To_Verify_Edit_Caption_SECTION_BUSES_CAMERA(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                               self.config.get(self.subsection, 'SECTION_BUSES_CAMERA'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_CAMERA'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_169_To_Verify_Fileupload_SECTION_BUSES_TYPEOFCAMERA(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                            self.config.get(self.subsection, 'SECTION_BUSES_TYPEOFCAMERA')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                        self.config.get(self.subsection, 'SECTION_BUSES_TYPEOFCAMERA'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
    ...
    def test_AST_170_To_Verify_Edit_Caption_SECTION_BUSES_TYPEOFCAMERA(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               self.config.get(self.subsection, 'SECTION_BUSES_TYPEOFCAMERA'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_TYPEOFCAMERA'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_174_To_Verify_Edit_Caption_SECTION_BUSES_TWOWAYRADIOS(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                               self.config.get(self.subsection, 'SECTION_BUSES_TWOWAYRADIOS'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_TWOWAYRADIOS'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_178_To_Verify_Edit_Caption_SECTION_BUSES_DISPATCHSYSTEM(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                               self.config.get(self.subsection, 'SECTION_BUSES_DISPATCHSYSTEM'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_DISPATCHSYSTEM'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_179_To_Verfiy_Add_Comment_SECTION_BUSES_DISPATCHSYSTEM(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_BUSES'),
                self.config.get(self.subsection, 'SECTION_BUSES_DISPATCHSYSTEM')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                           self.config.get(self.subsection, 'SECTION_BUSES_DISPATCHSYSTEM'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_186_To_Verify_Edit_Caption_SECTION_BUSES_HOUSED(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                               self.config.get(self.subsection, 'SECTION_BUSES_HOUSED'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_HOUSED'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_187_To_Verfiy_Add_Comment_SECTION_BUSES_HOUSED(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_BUSES'),
                            self.config.get(self.subsection, 'SECTION_BUSES_HOUSED')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                           self.config.get(self.subsection, 'SECTION_BUSES_HOUSED'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_190_To_Verify_Edit_Caption_SECTION_BUSES_ACCESS(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                            self.config.get(self.subsection, 'SECTION_BUSES_ACCESS'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                                      self.config.get(self.subsection, 'SECTION_BUSES_ACCESS'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_191_To_Verfiy_Add_Comment_SECTION_BUSES_ACCESS(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_BUSES'),
                            self.config.get(self.subsection, 'SECTION_BUSES_ACCESS')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_BUSES'),
                                           self.config.get(self.subsection, 'SECTION_BUSES_ACCESS'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_193_To_Verify_Fileupload_SECTION_WATER_UTILITY(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_WATER'),
                                                                         self.config.get(self.subsection, 'SECTION_WATER_UTILITY')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_WATER'),
                                        self.config.get(self.subsection, 'SECTION_WATER_UTILITY'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_WATER'),
                                                             self.config.get(self.subsection, 'SECTION_WATER_UTILITY'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_WATER'),
                                                      self.config.get(self.subsection, 'SECTION_WATER_UTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_195_To_Verfiy_Add_Comment_SECTION_WATER_UTILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_WATER'),
                                         self.config.get(self.subsection, 'SECTION_WATER_UTILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_WATER'),
                        self.config.get(self.subsection, 'SECTION_WATER_UTILITY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_WATER'),
                                           self.config.get(self.subsection, 'SECTION_WATER_UTILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_198_To_Verify_Edit_Caption_SECTION_WATER_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_WATER'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_WATER'),
                                    self.config.get(self.subsection, 'SECTION_WATER_LOSSOFUTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_WATER'),
                                                      self.config.get(self.subsection, 'SECTION_WATER_LOSSOFUTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_199_To_Verfiy_Add_Comment_SECTION_WATER_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_WATER'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_WATER'),
                    self.config.get(self.subsection, 'SECTION_WATER_LOSSOFUTILITY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_WATER'),
                                           self.config.get(self.subsection, 'SECTION_WATER_LOSSOFUTILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_201_To_Verify_Fileupload_SECTION_SECTION_ISP_NAME(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                                         self.config.get(self.subsection, 'SECTION_ISP_NAME')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_ISP'),
                                        self.config.get(self.subsection, 'SECTION_ISP_NAME'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                             self.config.get(self.subsection, 'SECTION_ISP_NAME'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                      self.config.get(self.subsection, 'SECTION_ISP_NAME'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_202_To_Verify_Edit_Caption_SECTION_ISP_NAME(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_ISP'),
                                               self.config.get(self.subsection, 'SECTION_ISP_NAME'),
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                               self.config.get(self.subsection, 'SECTION_ISP_NAME'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                      self.config.get(self.subsection, 'SECTION_ISP_NAME'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_203_To_Verfiy_Add_Comment_SECTION_ISP_NAME(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_ISP'),
                                         self.config.get(self.subsection, 'SECTION_ISP_NAME'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_ISP'),
                                self.config.get(self.subsection, 'SECTION_ISP_NAME')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_ISP'),
                                           self.config.get(self.subsection, 'SECTION_ISP_NAME'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_206_To_Verify_Edit_Caption_SECTION_ISP_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_ISP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                               self.config.get(self.subsection, 'SECTION_ISP_LOSSOFUTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_ISP'),
                                                      self.config.get(self.subsection, 'SECTION_ISP_LOSSOFUTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_209_To_Verify_Fileupload_SECTION_NATURALGAS_AVAILABILITY(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                                         self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                        self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                             self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                      self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_210_To_Verify_Edit_Caption_SECTION_NATURALGAS_AVAILABILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                               self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'),
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                               self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                      self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_211_To_Verfiy_Add_Comment_SECTION_NATURALGAS_AVAILABILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                         self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                 self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                           self.config.get(self.subsection, 'SECTION_NATURALGAS_AVAILABILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_214_To_Verify_Edit_Caption_SECTION_NATURALGAS_UTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                               self.config.get(self.subsection, 'SECTION_NATURALGAS_UTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                      self.config.get(self.subsection, 'SECTION_NATURALGAS_UTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_215_To_Verfiy_Add_Comment_SECTION_NATURALGAS_UTILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                        self.config.get(self.subsection, 'SECTION_NATURALGAS_UTILITY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                           self.config.get(self.subsection, 'SECTION_NATURALGAS_UTILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_218_To_Verify_Edit_Caption_SECTION_NATURALGAS_REQUIRES(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                               self.config.get(self.subsection, 'SECTION_NATURALGAS_REQUIRES'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                      self.config.get(self.subsection, 'SECTION_NATURALGAS_REQUIRES'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_219_To_Verfiy_Add_Comment_SECTION_NATURALGAS_REQUIRES(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                    self.config.get(self.subsection, 'SECTION_NATURALGAS_REQUIRES')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                           self.config.get(self.subsection, 'SECTION_NATURALGAS_REQUIRES'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_222_To_Verify_Edit_Caption_SECTION_NATURALGAS_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                               self.config.get(self.subsection, 'SECTION_NATURALGAS_LOSSOFUTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                                      self.config.get(self.subsection, 'SECTION_NATURALGAS_LOSSOFUTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_223_To_Verfiy_Add_Comment_SECTION_NATURALGAS_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                self.config.get(self.subsection, 'SECTION_NATURALGAS_LOSSOFUTILITY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_NATURALGAS'),
                                           self.config.get(self.subsection, 'SECTION_NATURALGAS_LOSSOFUTILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_225_To_Verify_Fileupload_SECTION_COMMUNICATION_RADIO(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                                         self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                        self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                             self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                      self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_226_To_Verify_Edit_Caption_SECTION_COMMUNICATION_RADIO(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                               self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'),
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                               self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                      self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_227_To_Verfiy_Add_Comment_SECTION_COMMUNICATION_RADIO(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                         self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                        self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                           self.config.get(self.subsection, 'SECTION_COMMUNICATION_RADIO'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    @attr(priority = 'high')
    #@SkipTest
    ...
    def test_AST_230_To_Verify_Edit_Caption_SECTION_COMMUNICATION_ALERT(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                               self.config.get(self.subsection, 'SECTION_COMMUNICATION_ALERT'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                      self.config.get(self.subsection, 'SECTION_COMMUNICATION_ALERT'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_231_To_Verfiy_Add_Comment_SECTION_COMMUNICATION_ALERT(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                        self.config.get(self.subsection, 'SECTION_COMMUNICATION_ALERT')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                           self.config.get(self.subsection, 'SECTION_COMMUNICATION_ALERT'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    @attr(priority = 'high')
    ...
    def test_AST_234_To_Verify_Edit_Caption_SECTION_COMMUNICATION_ENS(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                               self.config.get(self.subsection, 'SECTION_COMMUNICATION_ENS'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                      self.config.get(self.subsection, 'SECTION_COMMUNICATION_ENS'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_235_To_Verfiy_Add_Comment_SECTION_COMMUNICATION_ENS(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                            self.config.get(self.subsection, 'SECTION_COMMUNICATION_ENS')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                           self.config.get(self.subsection, 'SECTION_COMMUNICATION_ENS'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_238_To_Verify_Edit_Caption_SECTION_COMMUNICATION_PA(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                               self.config.get(self.subsection, 'SECTION_COMMUNICATION_PA'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                                      self.config.get(self.subsection, 'SECTION_COMMUNICATION_PA'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_239_To_Verfiy_Add_Comment_SECTION_COMMUNICATION_PA(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                        self.config.get(self.subsection, 'SECTION_COMMUNICATION_PA')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_COMMUNICATION'),
                                           self.config.get(self.subsection, 'SECTION_COMMUNICATION_PA'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_241_To_Verify_Fileupload_SECTION_LP_AVAILABILITY(self):
        count_of_image_before_upload = len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                                                         self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY')))
        self.ast.schooldata_upload_file(self.config.get(self.mainsection, 'SECTION_LP'),
                                        self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'),
                                        self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertGreater(len(self.ast.get_schooldata_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                                             self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'))),
                           count_of_image_before_upload, self.config.get(self.messages, 'MESSAGE_FILE_COULD_NOT_BE_UPLOADED'))
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_242_To_Verify_Edit_Caption_SECTION_LP_AVAILABILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'),
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                                               self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_243_To_Verfiy_Add_Comment_SECTION_LP_AVAILABILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                        self.config.get(self.subsection, 'SECTION_LP_AVAILABILITY')).get_attribute("value"), "Comment")
    ...
    def test_AST_246_To_Verify_Edit_Caption_SSECTION_LP_COMPANY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                                               self.config.get(self.subsection, 'SECTION_LP_COMPANY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_COMPANY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_247_To_Verfiy_Add_Comment_SECTION_LP_COMPANY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                                self.config.get(self.subsection, 'SECTION_LP_COMPANY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                           self.config.get(self.subsection, 'SECTION_LP_COMPANY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_250_To_Verify_Edit_Caption_SECTION_LP_TANKSIZE(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                                               self.config.get(self.subsection, 'SECTION_LP_TANKSIZE'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_TANKSIZE'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_251_To_Verfiy_Add_Comment_SECTION_LP_TANKSIZE(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                                self.config.get(self.subsection, 'SECTION_LP_TANKSIZE')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                           self.config.get(self.subsection, 'SECTION_LP_TANKSIZE'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_254_To_Verify_Edit_Caption_SECTION_LP_TANKLOCATION(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                            self.config.get(self.subsection, 'SECTION_LP_TANKLOCATION'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_TANKLOCATION'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_255_To_Verfiy_Add_Comment_SECTION_LP_TANKLOCATION(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                            self.config.get(self.subsection, 'SECTION_LP_TANKLOCATION')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                           self.config.get(self.subsection, 'SECTION_LP_TANKLOCATION'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_258_To_Verify_Edit_Caption_SECTION_LP_SERVICES(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                                               self.config.get(self.subsection, 'SECTION_LP_SERVICES'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_SERVICES'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_259_To_Verfiy_Add_Comment_SECTION_LP_SERVICES(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                    self.config.get(self.subsection, 'SECTION_LP_SERVICES')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                           self.config.get(self.subsection, 'SECTION_LP_SERVICES'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_262_To_Verify_Edit_Caption_SECTION_LP_POWERDURATION(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                                               self.config.get(self.subsection, 'SECTION_LP_POWERDURATION'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_POWERDURATION'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_263_To_Verfiy_Add_Comment_SECTION_LP_POWERDURATION(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                        self.config.get(self.subsection, 'SECTION_LP_POWERDURATION')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                           self.config.get(self.subsection, 'SECTION_LP_POWERDURATION'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_266_To_Verify_Edit_Caption_SECTION_LP_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_caption_image(self.config.get(self.mainsection, 'SECTION_LP'),
                                               ...
                                               self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_image_caption(self.config.get(self.mainsection, 'SECTION_LP'),
                                         self.config.get(self.subsection, 'SECTION_LP_LOSSOFUTILITY'))[0].text, "Hello")
        self.ast.delete_uploaded_files_assessmentpage(self.config.get(self.mainsection, 'SECTION_LP'),
                                                      self.config.get(self.subsection, 'SECTION_LP_LOSSOFUTILITY'),
                                                      self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
    ...
    def test_AST_267_To_Verfiy_Add_Comment_SECTION_LP_LOSSOFUTILITY(self):
        self.ast.schooldata_edit_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                         ...
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
        self.assertEqual(self.ast.get_schooldata_comment_textbox(self.config.get(self.mainsection, 'SECTION_LP'),
                        self.config.get(self.subsection,  'SECTION_LP_LOSSOFUTILITY')).get_attribute("value"), "Comment")
        self.ast.schooldata_delete_comment(self.config.get(self.mainsection, 'SECTION_LP'),
                                           self.config.get(self.subsection, 'SECTION_LP_LOSSOFUTILITY'),
                                         self.config.get(self.AssessmentSections, 'MAIN_SCHOOL_INFRASTRUCTURE'))
