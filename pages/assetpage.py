...
placedatafile = os.path.join(os.getcwd(), "data\json_Placedata.json")
os.chdir(cwd)
...
class AssetPage(BasePageClass):
    ...
    _asset_newcontact_delete_contact_icon_locator = "(//table[@id='contacts_table']//tbody//tr/td//a" \
                                                    "[@class='showaslink showaslink-edit'])[1]/../following-sibling::td[4]//a//img"
    ...
    _asset_contact_first_last_name_value_text = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                                "a[@class='showaslink showaslink-edit'])[1]"
    _asset_contact_title_value_text_locator = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                              "a[@class='showaslink showaslink-edit'])[1]/../following-sibling::td[1]"
    _asset_contact_phone_value_text_locator = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                              "a[@class='showaslink showaslink-edit'])[1]/../following-sibling::td[2]"
    _asset_contact_email_value_text_locator = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                              "a[@class='showaslink showaslink-edit'])[1]/../following-sibling::td[3]"
    ...
    _asset_point_of_contact_name_text_value_locator = "//table[@id='contacts_table']//tbody//tr/td//" \
                                                      "a[@class='showaslink showaslink-edit']"
    _asset_point_of_contact_title_text_value_locator = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                                       "a[@class='showaslink showaslink-edit'])/../following-sibling::td[1]"
    _asset_point_of_contact_phone_text_value_locator = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                                       "a[@class='showaslink showaslink-edit'])/../following-sibling::td[2]"
    _asset_point_of_contact_email_text_value_locator = "(//table[@id='contacts_table']//tbody//tr/td//" \
                                                       "a[@class='showaslink showaslink-edit'])/../following-sibling::td[3]"
    ...
    _asset_detail_edit_detail_district_number_textbox_locator = ".//*[@id='asset_details_modal']/" \
                                                                "div/div/form/div[1]/span[4]/div/span/input"
    ...
    _asset_photos_documents_window_upload_button_locator = ".//*[@id='widget_attach_document_modal']" \
                                                           "/div/div/div//button[contains(text(),'Upload')]"
    _asset_photos_documents_window_cancel_button_locator = ".//*[@id='widget_attach_document_modal']" \
    ...
    _asset_annotation_edit_window_visibility_dropdown_locator = "//label[text()='Visibility']" \
                                                                "//following-sibling::div//button[@data-toggle='dropdown']"
    ...
    _asset_annotation_delete_image_locator = "//div[contains(text(),'Annotations')]" \
                                             "//following-sibling::div/div/div/a[contains(@ng-click,'deleteItem')]"
    _asset_annotation_edit_image_locator = "//div[contains(text(),'Annotations')]" \
                                           "//following-sibling::div/div/div/a[contains(@ng-click,'editItem')]"

    # Location related locators
    ...
    def get_asset_photos_documents_image_caption_text(self, caption_val):
        caption_xpath = "//div[contains(text(),'Photos / Documents')]//following-sibling::div//ul//li[contains(text()," \
                        "'"+caption_val+"')]"
    ...
    def get_asset_photos_documents_header_caption_text(self, caption_val):
        caption_xpath = "//div[contains(text(),'Photos / Documents')]//following-sibling::div//a[contains(text()," \
                        "'"+caption_val+"')]"
        return self.driver.find_element_by_xpath(caption_xpath)
    ...
    def get_placedata(self):
        with open(placedatafile) as data_file:
    ...
    def create_new_contact(self, firstname, lastname, title="Title", phone=r"111-111-1111",
                           email=r"test@test.com", prefix="Shri", address1="Indecomm", address2=r"Brigade South Parade",
        ...
        WebDriverWait(self.driver,30).until(expected_conditions.text_to_be_present_in_element(
            (By.XPATH, self._assets_points_of_contact_title_locator), "Contact information"))
        ...
        WebDriverWait(self.driver,100).until(expected_conditions.text_to_be_present_in_element(
            (By.XPATH, self._asset_header_save_text_locator), "Saved"))
        ...
        if len(totalGraphInContainer) >= 1:
            ...
            for totalGraph in totalGraphInContainer:
                ...
                if totalGraph.text == "District":
                    assets = self.driver.find_elements_by_xpath("//div[starts-with(@id,'asset_graph-0')]//*[name()='svg' "
                    ...
                    assets = self.driver.find_elements_by_xpath("//div[starts-with(@id,'asset_graph-1')]//*[name()='svg' "
                                                                "and namespace-uri()='http://www.w3.org/2000/svg']/*"
                                                                "[name()='text']")
                    for asset in assets:
                        print asset.text
                    ...
                    assets = self.driver.find_elements_by_xpath("//div[starts-with(@id,'asset_graph-2')]//*[name()='svg' "
                                                                "and namespace-uri()='http://www.w3.org/2000/svg']/"
                                                                "*[name()='text']")
                    for asset in assets:
                        print asset.text
